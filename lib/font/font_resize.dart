...
class CustomFontResizeAuto extends StatefulWidget {
  @override
  _CustomFontResizeAutoState createState() => _CustomFontResizeAutoState();
}

class _CustomFontResizeAutoState extends State<CustomFontResizeAuto> {
  Rect? rect;
